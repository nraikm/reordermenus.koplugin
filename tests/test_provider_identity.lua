...
do
    ...
    if os.getenv("T7DEBUG") then
        ...
        local RegistryD = require("reorderingmenus_registry")
        local MaterializerD = require("reorderingmenus_materializer")
        ...
        local MenuOMD = require("reorderingmenus_menuorder_manager")
        _ = MenuOMD
        local nkeys = 0
